...
class TwitterDataSourceImplementation(DataSourceStage._Implementation):
    """导入社交网络信息
    """    
...
class TwitterDataSource(DataSourceStage):
    ...
    def __init__(self, allow_video=False, allow_retweet=True, consumer_key='', consumer_secret='', access_token_key='', access_token_secret='',
        ...
        Args:
            ...
            proxy (str): 代理服务器
        """        
        self.instance = TwitterDataSourceImplementation(allow_video, allow_retweet, consumer_key, consumer_secret, access_token_key, access_token_secret,
                                                        import_username, time_after, time_before, proxy)
        super().__init__()
